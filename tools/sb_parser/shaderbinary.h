...
struct alignas(4) InputUsageSlot {
    ...
    union {
        struct {
            uint8_t m_registerCount : 1; ///< If 0, count is 4DW; if 1, count is 8DW. Other sizes
                ///< are defined by the usage type.
            uint8_t m_resourceType : 1;  ///< If 0, resource type <c>V#</c>; if 1, resource type
        ...
        uint8_t m_srtSizeInDWordMinusOne; ///< Size of the SRT data; used for
