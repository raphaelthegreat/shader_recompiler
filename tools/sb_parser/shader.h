...
static_assert(sizeof(GnmInputUsageSlot) == 0x4, "");
...
static_assert(sizeof(GnmVertexInputSemantic) == 0x4, "");
...
static_assert(sizeof(GnmVertexExportSemantic) == 0x2, "");
...
static_assert(sizeof(GnmVsStageRegisters) == 0x1c, "");
...
static_assert(sizeof(GnmPixelInputSemantic) == 0x2, "");
...
static_assert(sizeof(GnmPsStageRegisters) == 0x30, "");
