...
bool sbInitEx(StructBank* pBank, uint32_t structSize, uint32_t cacheSize,
              uint32_t nPreallocations) {
...
bool sbAllocateNewStructPage(StructBank* pBank, uint32_t nAllocations) {
    ...
    do {
        ...
        // Allocate a new page.
        pPage = (StructBankPage*)malloc((pBank->m_alignedStructSize * nAllocations) +
